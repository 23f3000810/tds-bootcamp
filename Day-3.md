...
--- After Day-3 ---
I learned these things as well, apart from the checklist: The difference between `python -m venv venv` VS `uv` cmd.
---

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback: Very well structured and updated.
---
